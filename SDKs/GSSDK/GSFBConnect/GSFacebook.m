...
- (BOOL)authorizeWithFBAppAuth:(BOOL)tryFBAppAuth
  ...
  if (self.m_pLocalAppID) {
    [params setValue:self.m_pLocalAppID forKey:@"local_client_id"];
	}
  ...
  if ([device respondsToSelector:@selector(isMultitaskingSupported)] && [device isMultitaskingSupported]) {
    if (tryFBAppAuth) {
      ...
      NSString *fbAppUrl = [GSFBRequest serializeURL:urlPrefix params:params];
 ...
 localAppID:pLocalAppID
{
  ...
  _sessionDelegate = delegate;
	self.m_pLocalAppID = pLocalAppID;
