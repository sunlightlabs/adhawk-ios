...
@implementation GSFBLoginDialog

///////////////////////////////////////////////////////////////////////////////////////////////////
// public 

/*
 * initialize the GSFBLoginDialog with url and parameters
 */
- (id)initWithURL:(NSString*) loginURL 
      loginParams:(NSMutableDictionary*) params 
         delegate:(id <GSFBLoginDialogDelegate>) delegate{
...
/**
 * Override GSFBDialog : to call when the webView Dialog did succeed
 */
...
/**
 * Override GSFBDialog : to call with the login dialog get canceled 
 */
