 ...
 * The delegate.
 */
@property(nonatomic,assign) id<GSFBDialogDelegate> delegate;
 ...
 */
@protocol GSFBDialogDelegate <NSObject>
 ...
 */
- (void)dialogDidComplete:(GSFBDialog *)dialog;
 ...
 */
- (void)dialogDidNotComplete:(GSFBDialog *)dialog;

/**
 * Called when dialog failed to load due to an error.
 */
- (void)dialog:(GSFBDialog*)dialog didFailWithError:(NSError *)error;
 ...
 */
- (BOOL)dialog:(GSFBDialog*)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
